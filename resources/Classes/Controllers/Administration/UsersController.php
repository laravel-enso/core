...
use LaravelEnso\DataTable\Traits\DataTableEditor;
...
class UsersController extends Controller
{
    ...
    {
        return view('core::pages.administration.users.index');
    }
    ...
    public function show(User $user)
    {
        ...
        return view('core::pages.administration.users.show', compact('user', 'timeline'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('core::pages.administration.users.edit', compact('user', 'roles', 'owners'));
    }
