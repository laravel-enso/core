                            ...
                            <table style="margin:0 auto;" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td style="text-align: center;">
                                        {{--<a href="http://www.laravel-enso.com/"><img class="w320" width="311" height="83" src="#" alt="company logo" ></a>--}}
                                    </td>
                                </tr>
                            </table>
                                            ...
                                            <tr>
                                                <td style="text-align:center; margin:0 auto;">
                                                    ...
                                                    <div>
                                                        ...
                                                        <![endif]-->
                                                        <a href="{{$resetURL}}"
                                                           style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Reset Your Password</a>
                                                        <!--[if mso]>
                                                        </center>
                                                        </v:rect>
                                                        <![endif]-->
                                        ...
                                        <table cellspacing="0" cellpadding="0" bgcolor="#363636"  class="force-full-width">
                                            <tr>
                                                <td style="background-color:#363636; text-align:center;">
                                                    ...
                                                    <a href="https://www.facebook.com/laravel-enso.com">
                                            ...
                                            <tr>
                                                <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                                                    © 2016-2018 All rights reserved <span style='font-weight:bold;'>Enso</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="color:#f0f0f0; font-size: 14px; text-align:center; padding-bottom:4px;">
                                                    <a href="http://www.laravel-enso.com/">www.laravel-enso.com</a>
                                                </td>
                                            </tr>
                                            <tr>
