...
class CreateStructureForUsers extends StructureMigration
{
    ...
    protected $permissions = [
        ...
        ['name' => 'administration.users.selectOptions', 'description' => 'Get options for vue-select', 'type' => 0, 'default' => false],
    ...
    protected $menu = [
        'name' => 'Users', 'icon' => 'users', 'link' => 'administration.users.index', 'order' => 999, 'has_children' => false,
    ];
