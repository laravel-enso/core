...
use LaravelEnso\Charts\Classes\BarChart;
use LaravelEnso\Charts\Classes\BubbleChart;
use LaravelEnso\Charts\Classes\LineChart;
use LaravelEnso\Charts\Classes\PieChart;
use LaravelEnso\Charts\Classes\RadarChart;
...
class DashboardController extends Controller
{
    ...
    public function getBarChartData()
    {
        ...
        $datasets = [
            ...
            'Incasari' => [1250, 1730, 3300],
            'Profit'   => [1250 - 1233, 1730 - 1231, 3300 - 3123],
        ];
